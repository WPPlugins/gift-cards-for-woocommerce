	...
	if ( $is_giftcard == 'yes' ) {
		...
		<div>
			...
			<?php if ( $is_reload == "yes" ) { ?>
				<input type="checkbox" name="rpgc_reload_check" id="rpgc_reload_check" <?php if ( $rpgc_reloading == "on") { echo "checked=checked"; } ?>> <?php _e('Reload existing Gift Card', 'rpgiftcards' ); ?>
